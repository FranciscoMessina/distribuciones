...
import { DistribucionGumbelMinimo, type ParamsGumbelMinimo } from "@/lib/distribuciones"
...
export function GumbelMinimoDistributionPage() {
  const [params, setParams] = useState<ParamsGumbelMinimo | null>(null)
  ...
  const handleParamsChange = useCallback(
    (p: ParamsGumbelMinimo | null) => setParams(p),
    []
  )
  ...
  const G = DistribucionGumbelMinimo
  ...
  return (
    <div className="flex max-w-xl min-w-0 flex-1 flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Gumbel mínimo</h1>
